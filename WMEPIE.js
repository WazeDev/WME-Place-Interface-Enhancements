...
// @require      https://greasyfork.org/scripts/39208-wme-utils-google-link-enhancer/code/WME%20Utils%20-%20Google%20Link%20Enhancer.js?version=258664
// @license      GPLv3
// ==/UserScript==
...
//"#edit-buttons > div > div.toolbar-submenu.toolbar-group.toolbar-group-venues.ItemInactive > menu";
    ...
    function addHours(replaceAll = false) {
        ...
        if(!replaceAll)
            pasteHours = pasteHours + ',' + getOpeningHours(W.selectionManager.selectedItems[0].model).join(',');
